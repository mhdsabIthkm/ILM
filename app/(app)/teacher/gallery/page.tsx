      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          {vahdaMeeting1Media.map(m => (
            <div key={m.id} className="aspect-video bg-slate-100 rounded-lg flex flex-col items-center justify-center gap-1 border border-gray-200 cursor-pointer hover:bg-slate-200">
