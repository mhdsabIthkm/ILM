...
export default function StudentAwardsPage() {
  return (
    <div className="p-6 max-w-2xl mx-auto space-y-4">
      <h1 className="text-xl font-bold text-slate-900">My Awards</h1>
      {myAwards.length === 0 ? (
        <div className="bg-white rounded-lg border border-gray-200 p-8 text-center text-slate-400">No awards yet. Keep it up!</div>
      ) : myAwards.map(aw => (
